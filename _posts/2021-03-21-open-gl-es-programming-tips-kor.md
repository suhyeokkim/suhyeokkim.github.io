...
## single-precision 부동소수점 텍스쳐는 언제나 비쌉니다. (T6)
...
## 프레임 버퍼 오브젝트를(FBO) 동적으롸 생성되는 텍스쳐를 위해 사용하십시오. (T13)
